...
public abstract class ApplyFunctor {
	...
	public static RootCallTarget apply(OzLanguage language, Object functor, Object imports, String name) {
		...
		return OzRootNode.createTopRootNode(language, name, node).toCallTarget();
	}
